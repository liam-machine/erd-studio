...
vi.mock('../../src/host/canvasEnvironment', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../../src/host/canvasEnvironment')>()),
  useSend: () => mockSend,
}));
...
vi.mock('../../src/components/common/DataTypeSelect', () => ({
